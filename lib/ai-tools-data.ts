...
export const ALL_TOOLS_META: AIToolMeta[] = [
  ...
  { id: 'photo-enhancer', name: 'Photo Enhancer', description: 'AI image optimization', longDescription: 'Enhance your photos with AI-powered adjustments for lighting, color, and quality optimization.', category: 'content', credits: 2, hasRunner: false },
  { id: 'ai-chatter', name: 'AI Chatter', description: 'Automated fan responses', longDescription: 'Train AI to respond to fans in your voice, handling common questions and keeping conversations going 24/7.', category: 'engagement', badge: 'Popular', credits: 1, hasRunner: false },
  ...
  { id: 'churn-predictor', name: 'Churn Predictor', description: 'Identify at-risk subscribers', longDescription: 'Predict which fans are likely to unsubscribe and get personalized retention strategies.', category: 'analytics', credits: 2, hasRunner: true },
  { id: 'cosmic-calendar', name: 'Cosmic Calendar', description: 'Astrology-powered scheduling', longDescription: 'Plan your content around celestial events, zodiac cycles, and lunar phases for maximum engagement.', category: 'analytics', credits: 1, hasRunner: false },
